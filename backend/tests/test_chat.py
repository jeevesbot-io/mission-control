...
def test_send_message_success():
    ...
    with patch("modules.chat.service.ChatService.send_message", new_callable=AsyncMock) as mock:
...
def test_chat_health_available():
    ...
    with patch("modules.chat.service.ChatService.check_health", new_callable=AsyncMock) as mock:
